...
GuiQt::GuiQt(QWidget *parent) : QWidget(parent)
{
  ...
  // match
  connect(pushButton, &QPushButton::clicked, this, &GuiQt::writeToDebug);
  ...
  connect(fatal, &QPushButton::clicked, this, &GuiQt::close);// could just use close
};

void GuiQt::writeToDebug(void)
{
